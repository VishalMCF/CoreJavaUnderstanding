package demo.networking.networkscalibility.perconnection;
...
public class ThreadPerConnectionServer implements Runnable {
    ...
    public ThreadPerConnectionServer(Socket socket){
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true){
                ...
                new Thread(new demo.networking.networkscalibility.perrequest.SimpleMultiThreadedServer(clientSocket)).start();
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
